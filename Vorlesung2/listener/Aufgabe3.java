...
//		plainRadio.addItemListener(l);
		
		okBtn.addActionListener(new MyListener());
		
		cnzlBtn.addActionListener(var -> textField.setText(""));
		
//		cnzlBtn.addActionListener(new ActionListener() {
//			
//			@Override
	...
	private class MyListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			if (boldRadio.isSelected()){
				...
				System.out.println("plain ist ausgewählt");
			}
